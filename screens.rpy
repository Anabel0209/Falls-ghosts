...
screen qte_button_alttab():
    ...
    vbox:
        ...
        button:
            ...
            xalign 0.5
            xysize 150, 103
            background Animation("images_png/image_croix_on.png", 0.5, "images_png/image_croix_off.png", 0.5) #change to image, etc
            activate_sound "sound/gui/correct-answer-bell-gliss-04.mp3"
...
##############################################
screen qte_button_keypress(trigger_key_display):
    #button press qte
    #key input qte
